...
<body
	...
	<div class="right">
    	<h2 align="center"><span>菜单</span> </h2>
          <ul>
            <li><a href="#"> 主页</a></li>
            <li ><a href="user_mana_userlist.jsp" style="color: #ea7d1b;">用户列表</a></li>
    ...
    <div class="userlist">
        <button id="tianjia" class="btn  btn-primary" style="margin-left: 100px;margin-top: 50px;width:100px;"><span class="glyphicon glyphicon-plus"  ></span>添加</button>
        <button id="xiugai" class="btn  btn-primary" style="margin-left: 100px;margin-top: 50px;width:100px;"><span class="glyphicon glyphicon-edit"  ></span>修改</button>
        <button id="shanchu" class="btn  btn-primary" style="margin-left: 100px;margin-top: 50px;width:100px;"><span class="glyphicon glyphicon-trash"  ></span>删除</button>
  ...
  <form action="">
    	...
    	<div class="container_input" style="margin-top: 50px;">
    		...
    		<input id="psword1" type="text" placeholder="密码">
    	</div>
    	<div class="container_input" style="margin-top: 50px;">
    		<label for="psword2">确认密码：</label>
    		<input id="psword2" type="text" placeholder="确认密码">
    	</div>
